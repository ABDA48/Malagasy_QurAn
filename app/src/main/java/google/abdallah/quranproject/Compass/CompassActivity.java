...
import google.abdallah.quranproject.Activity.FavoriesActivity;
...
public class CompassActivity extends AppCompatActivity {
    ...
    private TextView tvYourLocation,tvCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvCity=findViewById(R.id.citylocation);
        //////////////////////////////////////////
        ...
        try {
            ...
            ((Toolbar) findViewById(R.id.toolbar)).setTitle(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.TOOLBAR_TITLE)) ?
                            intent.getExtras().getString(Constant.TOOLBAR_TITLE) : getString(R.string.app_name));

            // Toolbar Title Color
            ((Toolbar) findViewById(R.id.toolbar)).setTitleTextColor(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.TOOLBAR_TITLE_COLOR)) ?
                            Color.parseColor(intent.getExtras().getString(Constant.TOOLBAR_TITLE_COLOR)) :
            ...
            findViewById(R.id.toolbar).setBackgroundColor(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.TOOLBAR_BG_COLOR)) ?
                            Color.parseColor(intent.getExtras().getString(Constant.TOOLBAR_BG_COLOR)) :
                            Color.parseColor("#" + Integer.toHexString(
           ...
           /* findViewById(R.id.root).setBackgroundColor(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.COMPASS_BG_COLOR)) ?
                            Color.parseColor(intent.getExtras().getString(Constant.COMPASS_BG_COLOR)) :
                            Color.parseColor("#" + Integer.toHexString(
                                    ContextCompat.getColor(this, R.color.colorAccent))));*/
            ...
            ((TextView) findViewById(R.id.angle)).setTextColor(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.ANGLE_TEXT_COLOR)) ?
                            Color.parseColor(intent.getExtras().getString(Constant.ANGLE_TEXT_COLOR)) :
                            Color.parseColor("#" + Integer.toHexString(
                                    ContextCompat.getColor(this, android.R.color.white))));
            ...
            ((ImageView) findViewById(R.id.dial)).setImageResource(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.DRAWABLE_DIAL)) ?
                            intent.getExtras().getInt(Constant.DRAWABLE_DIAL) : R.drawable.dial);

            // Qibla Indicator
            ((ImageView) findViewById(R.id.qibla_indicator)).setImageResource(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.DRAWABLE_QIBLA)) ?
                            intent.getExtras().getInt(Constant.DRAWABLE_QIBLA) : R.drawable.qibla);

            // Footer Image
            findViewById(R.id.footer_image).setVisibility(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.FOOTER_IMAGE_VISIBLE)) ?
                            intent.getExtras().getInt(Constant.FOOTER_IMAGE_VISIBLE) : View.VISIBLE);

            // Your Location TextView
            findViewById(R.id.your_location).setVisibility(
                    (intent.getExtras() != null &&
                            intent.getExtras().containsKey(Constant.LOCATION_TEXT_VISIBLE)) ?
                            intent.getExtras().getInt(Constant.LOCATION_TEXT_VISIBLE) : View.VISIBLE);
    ...
    public void getBearing() {
        ...
        if (kaabaDegs > 0.0001) {
            ...
            if(gps.getLocation() != null) {
                ...
                try {
                    List<Address> addresses = geocoder.getFromLocation(gps.getLocation().getLatitude(), gps.getLocation().getLongitude(), 1);
                    StringBuffer stringBuffer = new StringBuffer();
                    if (addresses.size() > 0) {
                        Address address = addresses.get(0);
                        stringBuffer.append("Adresss :" + address.getAddressLine(0) + "\n");

                        tvCity.setText(stringBuffer.toString());
                    } else {
